"Resource/UI/Econ/ItemModelPanelCharWeaponInspect.res"
{
	...
	"stickerpreview_sg553"
	{
		...
		"config"
		{
			...
			"root_camera_fov"     "55.0"
			"item_rotate"	  "y[-40 30] x[ 0 0 ]"
			"item_orient"	   "0. 0.0 0.0"
		}
	}
